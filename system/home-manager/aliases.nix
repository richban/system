{
    ...
    n.connections="lsof -l -i +L -R -V"
    n.established="lsof -l -i +L -R -V | grep ESTABLISHED"
    n.externalip="curl -s http://checkip.dyndns.org/ | sed 's/[a-zA-Z<>/ :]//g'"
    n.internalip="ifconfig en0 | egrep -o '([0-9]+\.[0-9]+\.[0-9]+\.[0-9]+)'"
