...
if [[ ! -f $HOME/.pyenv/versions/neovim3/bin/pip ]]; then
    ...
    $HOME/.pyenv/versions/neovim3/bin/pip install --upgrade --no-cache neovim pynvim doq qtconsole pylsp-mypy python-lsp-black pyls-isort pyls-flake8 pyls-memestra pep8-naming 'python-lsp-server[all]' jupyter_qtconsole_colorschemes rope pylsp-rope mccabe
fi
