...
_G.packer_plugins = {
  ...
  ["ISuckAtSpelling.nvim"] = {
    ...
    url = "https://github.com/Pocco81/ISuckAtSpelling.nvim"
  },
  ["better-escape.vim"] = {
  ...
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/Users/rbanyi/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  ["dashboard-nvim"] = {
    config = { "require('rb.dashboard')" },
    loaded = true,
    path = "/Users/rbanyi/.local/share/nvim/site/pack/packer/start/dashboard-nvim",
  ...
  ["dracula.nvim"] = {
    loaded = true,
    path = "/Users/rbanyi/.local/share/nvim/site/pack/packer/start/dracula.nvim",
  ...
  ["format.nvim"] = {
    commands = { "Format" },
    config = { "require('rb.code-formatter')" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/Users/rbanyi/.local/share/nvim/site/pack/packer/opt/format.nvim",
  ...
  ["indent-blankline.nvim"] = {
    config = { "require('rb.indent-blankline')" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/Users/rbanyi/.local/share/nvim/site/pack/packer/opt/indent-blankline.nvim",
  ...
  ["nvim-cmp"] = {
    ...
    loaded = true,
    path = "/Users/rbanyi/.local/share/nvim/site/pack/packer/start/nvim-cmp",
  ...
  ["nvim-colorizer.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/rbanyi/.local/share/nvim/site/pack/packer/opt/nvim-colorizer.lua",
    url = "https://github.com/norcalli/nvim-colorizer.lua"
  },
  ["nvim-comment"] = {
    config = { "\27LJ\2\n:\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\17nvim_comment\frequire\0" },
    loaded = true,
    path = "/Users/rbanyi/.local/share/nvim/site/pack/packer/start/nvim-comment",
  ...
  ["nvim-tree.lua"] = {
    config = { "require('rb.nvim-tree-config')" },
    loaded = true,
  ...
  ["nvim-treesitter"] = {
    ...
    config = { "require('rb.nvim-treesitter-config')" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
    path = "/Users/rbanyi/.local/share/nvim/site/pack/packer/opt/nvim-treesitter",
  ...
  ["nvim-ts-rainbow"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/rbanyi/.local/share/nvim/site/pack/packer/opt/nvim-ts-rainbow",
  ...
  ["telescope-repo.nvim"] = {
    loaded = true,
    path = "/Users/rbanyi/.local/share/nvim/site/pack/packer/start/telescope-repo.nvim",
...
try_loadstring("\27LJ\2\n-\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\18rb.statusline\frequire\0", "config", "lualine.nvim")
...
try_loadstring("\27LJ\2\n3\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\24rb.plugins.nvim-cmp\frequire\0", "config", "nvim-cmp")
time([[Config for nvim-cmp]], false)
-- Config for: nvim-tree.lua
time([[Config for nvim-tree.lua]], true)
require('rb.nvim-tree-config')
