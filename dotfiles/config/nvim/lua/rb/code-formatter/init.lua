...
null_ls.setup({
  sources = {
    ...
    formatting.clang_format, formatting.cmake_format, formatting.bean_format, formatting.fixjson,
    formatting.sqlformat, formatting.terrafmt, formatting.terraform_fmt, formatting.trim_whitespace,
    diagnostics.editorconfig_checker, diagnostics.gitlint, diagnostics.markdownlint,
    diagnostics.misspell, diagnostics.shellcheck, diagnostics.write_good,
