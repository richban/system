...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(root_indicator user dir dir_writable_joined vcs ssh)
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status pyenv nvm background_jobs)
